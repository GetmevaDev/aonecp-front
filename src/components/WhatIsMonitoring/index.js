    ...
    <div className={styles.monitoring}>
      <div className="container">
        <div className={styles.monitoringBlock}>
          ...
          <div className={styles.monitoringBlockRight} style={{ marginTop: 100 }}>
        ...
        <div className={styles.monitoringBlock}>
          <div className={styles.monitoringBlockRight}>
            ...
            <p className={`${styles.monitoringDesc} ${styles.monitoringDescLeft}`}>
              ...
              monitoring and identity theft insurance! That is a huge peace of mind that many people
              like you may need as hacking gets significantly worse or more advanced. What this does
              for you is it provides identity theft coverage and insurance in case, God forbid, you
              do get your identity stolen. It also gives you access to all 3 of your credit reports
              from the credit bureaus. You also get a credit score from all 3 credit bureaus, and
              fraud alert assistance. Who's the best to go with though?
            </p>
          </div>
          <div className={styles.monitoringBlockLeft}>
            <img src={Workers} alt="" />
        ...
        <div className={styles.monitoringBlock}>
          ...
          <div className={styles.monitoringBlockRight}>
            ...
            <p className={styles.monitoringDesc}>
              ...
              reports about bank accounts opened in your name and possible incorrect information on
              it. This is on top of their credit monitoring and daily alerts from transunion! :)
              ...
              lost while resolving a stolen identity event). It’s your decision but if we would say
              if you want the best peace of mind, your best choice is identityiq.com.
            </p>
          </div>
        </div>
      </div>
